...
func PersistentFlags(parentCmd *cobra.Command, opts *ToolboxOptions) {
	...
	persistentFlags.StringVar(&opts.Cfg.TelemetryGCPProject, "telemetry-gcp-project", "", "Google Cloud project ID to use for telemetry-gcp. Defaults to GOOGLE_CLOUD_PROJECT if set.")
