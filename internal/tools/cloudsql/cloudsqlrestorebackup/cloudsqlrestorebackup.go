...
func (cfg Config) Initialize(srcs map[string]sources.Source) (tools.Tool, error) {
	...
	if project != "" {
		targetProjectParam = parameters.NewStringParameter("target_project", "The GCP project ID. This is pre-configured; do not ask for it unless the user explicitly provides a different one.", parameters.WithStringDefault(project))
	} else {
