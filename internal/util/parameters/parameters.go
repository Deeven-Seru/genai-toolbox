...
func WithIntRangeMin(v int) IntParameterOption { return func(p *IntParameter) { p.MinValue = &v } }
func WithIntRangeMax(v int) IntParameterOption { return func(p *IntParameter) { p.MaxValue = &v } }
...
func WithFloatRangeMin(v float64) FloatParameterOption {
	return func(p *FloatParameter) { p.MinValue = &v }
}
func WithFloatRangeMax(v float64) FloatParameterOption {
